...
class TestPacketsOpcodes(unittest.TestCase):
    ...
    def test_extended_version(self):
        data = (
            b"\x54\x65\x73\x74\x20\x32\x70\x69\x6e\x67\x20\x76\x65\x72\x73\x69\x6f\x6e"
        )
...
class TestPacketsReference(unittest.TestCase):
    ...
    def test_reference_2b(self):
        ...
        packet.opcodes[packets.OpcodeInReplyTo.id].message_id = (
    ...
    def test_reference_4c(self):
        ...
        packet.opcodes[packets.OpcodeInvestigationSeen.id] = (
